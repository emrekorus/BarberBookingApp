...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    primaryColor: Color(0xFFE70506),
    primaryColorDark: Color(0xFF8A1010),
  ...
  static final TextStyle _greetingLightBold = TextStyle(
    color: Colors.black,
  ...
  static final TextStyle _greetingDarkBold = _greetingLightBold.copyWith(color: Colors.black);
